      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-8 border border-slate-200 dark:border-slate-700 transition-colors duration-300">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 dark:text-slate-400">Join thousands of users staying informed with AI</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              />
              <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">At least 3 characters</p>
            </div>
